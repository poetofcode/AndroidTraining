...
class FragViewModel : ViewModel() {
    ...
    val cats = listOf(
        ...
        Cat(
            "Белый",
            "https://cdn.mos.cms.futurecdn.net/AESHMNgFLdtaTbA7vsGjmn.jpg"
        ),
        Cat(
            "Сфинкс",
            "https://static.onecms.io/wp-content/uploads/sites/20/2021/08/06/cat.jpg"
        ),
        Cat(
            "Кремовая",
        ...
        Cat(
            "Белый",
            "https://i.guim.co.uk/img/media/7a633730f5f90db3c12f6efc954a2d5b475c3d4a/0_138_5544_3327/master/5544.jpg?width=465&quality=45&auto=format&fit=max&dpr=2&s=ea010b46d8b9ac7885098124af7790f4"
        )
    )
